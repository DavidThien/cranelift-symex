...
/* package cranelift-symex-0.1.0.0 */
#ifndef VERSION_cranelift_symex
#define VERSION_cranelift_symex "0.1.0.0"
#endif /* VERSION_cranelift_symex */
#ifndef MIN_VERSION_cranelift_symex
#define MIN_VERSION_cranelift_symex(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cranelift_symex */
...
#define CURRENT_PACKAGE_KEY "cranelift-symex-0.1.0.0-AdbwowVI31t33gCxfH1the"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "cranelift-symex-0.1.0.0-AdbwowVI31t33gCxfH1the"
